...
export type OutcomeInput = { registry_key: string; registry_version: 1; outcome_role: "primary" | "secondary"; aggregation_method: string; expected_direction: "increase" | "decrease" | "maintain" | "unknown"; source_config: Record<string, never>; user_condition_id?: string; symptom_id?: string; user_symptom_id?: string; exercise_id?: string; success_criterion?: SuccessCriterion };
