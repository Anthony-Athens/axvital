export type TimelineEventType="checkin"|"weight"|"food"|"meal"|"fluid"|"supplement"|"symptom"|"medication"|"workout"|"habit"|"protocol"|"experiment"|"note"|"other";
...
export type TimelineEvent={id:string;sourceId:string;sourceType:string;eventType:TimelineEventType;occurredAt:string;endedAt:string|null;title:string;subtitle:string|null;description:string|null;status:string|null;metadata:TimelineMetadata;editable:boolean;deletable:boolean;detailHref:string|null;editHref:string|null};
